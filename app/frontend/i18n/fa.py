...
LBL_DEVELOPER = "توسعه‌دهنده: {name}"
NAV_HOME = "خانه"
NAV_INVENTORY = "موجودی کالا"
NAV_REPORTS = "گزارش‌ها"
NAV_USERS = "مدیریت کاربران"
NAV_LOGS = "گزارش رویدادها"

# --- Logs viewer (admin) -----------------------------------------------------
TITLE_LOGS = "گزارش رویدادها (لاگ‌ها)"
LOGS_UNLOCK_HINT = "این بخش با رمز عبور مدیر محافظت می‌شود. برای مشاهدهٔ لاگ‌ها رمز عبور خود را وارد کنید."
LOGS_EMPTY = "هیچ فایل لاگی یافت نشد."
LOGS_LOCKED = "برای مشاهدهٔ لاگ‌ها باید رمز عبور مدیر را وارد کنید."
BTN_UNLOCK_LOGS = "باز کردن قفل"
LBL_LOG_FILE = "فایل لاگ"
